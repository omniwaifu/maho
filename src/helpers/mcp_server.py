...
mcp_server: FastMCP = FastMCP(
    name="Maho integrated MCP Server",
    instructions="""
    Connect to remote Maho instance.
    Maho is a general AI assistant controlling it's linux environment.
    Maho can install software, manage files, execute commands, code, use internet, etc.
    Maho's environment is isolated unless configured otherwise.
    """,
)
...
Send a message to the remote Maho Instance.
This tool is used to send a message to the remote Maho Instance connected remotely via MCP.
"""
...
async def send_message(
    message: Annotated[
        str,
        Field(
            description="The message to send to the remote Maho Instance",
            title="message",
        ),
    ],
    attachments: (
        Annotated[
            list[str],
            Field(
                description="Optional: A list of attachments (file paths or web urls) to send to the remote Maho Instance with the message. Default: Empty list",
                title="attachments",
            ),
        ]
        | None
...
Finish a chat with the remote Maho Instance.
This tool is used to finish a persistent chat (send_message with persistent_chat=True) with the remote Maho Instance connected remotely via MCP.
If you want to continue the chat, use the send_message tool instead.
Always use this tool to finish persistent chat conversations with remote Maho.
"""
